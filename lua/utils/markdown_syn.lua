...
syn match mdCompleteMark "- \[[x|X]\]" contained containedin=mdCompleteTask conceal cchar=
...
syn match mdItem "^\s*[\*-] [^\*-]+$" contains=mdBullet
...
" syntax match todoCheckbox "\v.*\[[x|X]\]"hs=e-2 conceal cchar=
syntax match todoCheckbox "\v.*\[[x|X]\]"hs=e-4 conceal cchar=
